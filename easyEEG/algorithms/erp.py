...
def ERP(self, compare=False, comparison_params=comparison_params):
    ...
    return structure.AnalyzedData('ERP', erp_batch, stats_data, default_plot_params=default_plot_params)
...
def topo_ERPs(self, compare=False, comparison_params=comparison_params):
    ...
    return structure.AnalyzedData('topo_ERPs', erp_batch, stats_data, default_plot_params=default_plot_params)
...
def ERPs(self):
    ...
    return structure.AnalyzedData('ERPs', erp_batch, stats_data, default_plot_params=default_plot_params)
...
def GFP(self, compare=False, comparison_params=comparison_params):
    ...
    default_plot_params = dict(plot_type=['direct', 'waveform'], y_title='GFP', err_style='ci_band',
                               color="Set1", style='darkgrid', compare=compare, win=comparison_params['win'], sig_limit=0.05)
    return structure.AnalyzedData('GFP', gfp_batch, stats_data, default_plot_params=default_plot_params)
